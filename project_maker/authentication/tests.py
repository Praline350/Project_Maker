...
class TestLoginPageView:
    ...
    def setup(self):
        self.client = Client()
        self.signup_url = reverse('login')  # Remplace 'login' par le nom de ton URL pour la vue
    ...
    def test_login_with_valid_credentials(self):
        ...
        user = self.UserModel.objects.create_user(username='testuser', password='password123')
